...
SWEP.Trivia_Desc = "Includes a counter weight system that mitigates recoil."
...
SWEP.ViewModel = "models/weapons/arccw/c_lowpolya545.mdl"
...
local path = "weapons/arccw/a545/"
SWEP.FirstShootSound = path .. "fire_initial.ogg"
SWEP.ShootSound = {path .. "fire_auto01.ogg", path .. "fire_auto02.ogg", path .. "fire_auto03.ogg"}
...
SWEP.BulletBones = {
    [1] = "bullet",    [2] = "bullets2",    [3] = "bullets3"
}
